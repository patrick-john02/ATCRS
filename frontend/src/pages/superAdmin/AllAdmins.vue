...
import { useAdminUsersStore } from '@/stores/useAdminUsers'
import type {
  ColumnFiltersState,
  ExpandedState,
  SortingState,
...
const columnHelper = createColumnHelper<ViewAdmin>()
...
<template>
  <div class="w-full space-y-4">
    <!-- Error Alert -->
    <Alert v-if="adminStore.error" variant="destructive">
      <AlertDescription>
        {{ adminStore.error }}
      </AlertDescription>
    </Alert>
        ...
        <Dialog v-model:open="isDialogOpen">
          ...
          <DialogContent class="sm:max-w-lg">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <DialogFooter>
                <Button type="submit" :disabled="adminStore.loading">
                  <Loader2 v-if="adminStore.loading" class="mr-2 h-4 w-4 animate-spin" />
                  Save
                </Button>
              </DialogFooter>
            </form>
    ...
    <div class="rounded-md border">
      <div class="relative overflow-auto max-h-[600px]">
        <Table>
          ...
          <TableBody>
            <template v-if="!adminStore.loading && table.getRowModel().rows.length">
              <TableRow
            ...
            <TableRow v-else-if="adminStore.loading">
